...
// get All users
const getAllUsers = (0, createAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
const getSingleUser = (0, createAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield user_service_1.UsersService.getSingleUser(req.params.id);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
// delete a user
const deleteUser = (0, createAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
